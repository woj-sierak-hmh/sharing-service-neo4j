...
const createSeedData = async () => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      // const result1 =
      await session.run(statement, share1);
      // const result2 =
      await session.run(statement, share2);
      // const result3 =
      await session.run(statement, share3);
...
export { createSeedData, removeAllData };
